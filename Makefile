...
#    Updated: 2024/07/13 10:15:11 by adherrer         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
OBJ_DIR     := obj/
CC          := gcc
CFLAGS      := -g -O3 -Wall -Werror -Wextra -ffast-math -funroll-loops -march=native -flto -fsanitize=address,leak
FSANITIZE   := 
RM          := rm -f
...
SRC_FILES   =   main mathmatrix utils_matrix maps utils_map valid polarize peripheral utils_peripheral positions draw utils_draw color projection utils_color
